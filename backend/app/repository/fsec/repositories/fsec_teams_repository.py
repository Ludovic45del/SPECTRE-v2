...
from app.mapper.fsec.fsec_teams_mapper import fsec_teams_mapper_bean_to_entity, fsec_teams_mapper_entity_to_bean
...
class FsecTeamsRepository(BaseChildRepository[FsecTeamsBean, FsecTeamsEntity], IFsecTeamsRepository):
