...
class TestListUsers:
    ...
    def test_list_users_default_params(self, mock_user_repository):
        ...
        mock_user_repository.get_all.assert_called_once_with(offset=0, limit=50)
    ...
    def test_list_users_with_pagination_params(self, mock_user_repository):
        ...
        assert result == beans
        mock_user_repository.get_all.assert_called_once_with(offset=2, limit=5)
    ...
    def test_list_users_offset_exceeds_length(self, mock_user_repository):
        ...
        assert result == []
        mock_user_repository.get_all.assert_called_once_with(offset=100, limit=10)
