...
class FaSerializer(serializers.Serializer):
    ...
    fsec_step_other = serializers.CharField(max_length=255, required=False, allow_blank=True, allow_null=True)
    ...
    observation = serializers.CharField(max_length=4000, required=False, allow_blank=True)
    location_equipment = serializers.CharField(max_length=255, required=False, allow_blank=True, allow_null=True)
    quick_analysis = serializers.CharField(max_length=4000, required=False, allow_blank=True)
    immediate_measures = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
    ...
    iec_validation_open_name = serializers.CharField(max_length=100, required=False, allow_blank=True, allow_null=True)
    iec_validation_open_user_uuid = serializers.UUIDField(required=False, allow_null=True)

    # Phase En cours
    cause = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
    experience_impact = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
    iec_validation_progress = serializers.BooleanField(required=False, default=False)
    iec_validation_progress_date = serializers.DateField(required=False, allow_null=True)
    iec_validation_progress_name = serializers.CharField(
        max_length=100, required=False, allow_blank=True, allow_null=True
    )
    iec_validation_progress_user_uuid = serializers.UUIDField(required=False, allow_null=True)

    # Phase Clos
    closure_validation = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
    closure_date = serializers.DateField(required=False, allow_null=True)
    closure_validator_name = serializers.CharField(max_length=100, required=False, allow_blank=True, allow_null=True)
...
class FaValidatePhaseSerializer(serializers.Serializer):
    ...
    validator_name = serializers.CharField(max_length=100, required=False, allow_blank=True)
