...
from app.api.embase.serializers import EtalonnageListQuerySerializer, EtalonnageSerializer
...
from app.mapper.embase.etalonnage_mapper import etalonnage_mapper_api_to_bean, etalonnage_mapper_bean_to_api
...
class EtalonnageController(PaginatedControllerMixin, ViewSet):
    ...
    def create(self, request) -> JsonResponse:
        ...
        return JsonResponse(etalonnage_mapper_bean_to_api(result), status=201, encoder=DjangoJSONEncoder)
    ...
    def list(self, request) -> JsonResponse:
        ...
        source = LazyRepositoryList(
            ...
            count_func=lambda: count_etalonnages_by_embase(self.repository, embase_uuid, voie=voie),
        )
    ...
    def retrieve(self, request, uuid=None) -> JsonResponse:
        ...
        return JsonResponse(etalonnage_mapper_bean_to_api(bean), encoder=DjangoJSONEncoder)
