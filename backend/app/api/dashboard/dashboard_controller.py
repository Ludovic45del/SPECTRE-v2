...
from app.mapper.dashboard.dashboard_mapper import dashboard_activity_item_bean_to_api, dashboard_counts_bean_to_api
from app.repository.dashboard.repositories.dashboard_repository import DashboardRepository
        ...
        return JsonResponse(
            {
                ...
                "recent_activity": [dashboard_activity_item_bean_to_api(item) for item in recent_activity],
            },
