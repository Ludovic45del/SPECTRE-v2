...
class AssemblyStepSerializer(serializers.Serializer):
    ...
    operator = serializers.CharField(max_length=200, required=False, allow_blank=True, allow_null=True)
    ...
    assembly_bench_ids = serializers.ListField(child=serializers.IntegerField(), required=False, allow_empty=True)
...
class MetrologyStepSerializer(serializers.Serializer):
    ...
    metrologist_name = serializers.CharField(max_length=255, required=False, allow_blank=True, allow_null=True)
...
class SealingStepSerializer(serializers.Serializer):
    ...
    rack_id = serializers.IntegerField(required=False, allow_null=True, min_value=0)
    interface_io = serializers.CharField(max_length=50, required=False, allow_blank=True, allow_null=True)
    comments = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
...
class PicturesStepSerializer(serializers.Serializer):
    ...
    uuid = serializers.UUIDField(required=False)
    fsec_version_id = serializers.UUIDField(required=True)
    operator = serializers.CharField(max_length=255, required=False, allow_blank=True, allow_null=True)
    operator_user_uuid = serializers.UUIDField(required=False, allow_null=True)
    date = serializers.DateField(required=False, allow_null=True)
    comments = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
...
class PhotoViewSerializer(serializers.Serializer):
    ...
    link = serializers.CharField(max_length=500, required=False, allow_blank=True, allow_null=True)
    comments = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
...
class AirtightnessTestLpStepSerializer(serializers.Serializer):
    ...
    operator = serializers.CharField(max_length=200, required=False, allow_blank=True, allow_null=True)
    operator_user_uuid = serializers.UUIDField(required=False, allow_null=True)
    leak_rate_dtri = serializers.CharField(max_length=200, required=False, allow_blank=True, allow_null=True)
    gas_type = serializers.CharField(max_length=200, required=False, allow_blank=True, allow_null=True)
...
class GasFillingBpStepSerializer(serializers.Serializer):
    ...
    observations = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
...
class DepressurizationStepSerializer(serializers.Serializer):
    ...
    enclosure_pressure_measured = serializers.FloatField(required=False, allow_null=True)
    start_time = serializers.DateTimeField(required=False, allow_null=True)
    end_time = serializers.DateTimeField(required=False, allow_null=True)
    observations = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
    depressurization_time_before_firing = serializers.FloatField(required=False, allow_null=True)
    computed_pressure_before_firing = serializers.FloatField(required=False, allow_null=True)
